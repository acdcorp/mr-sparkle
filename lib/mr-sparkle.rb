...
module Mr
  module Sparkle
    ...
    DEFAULT_RELOAD_PATTERN = /\.(?:builder|coffee|creole|css|slim|erb|erubis|haml|html|js|less|liquid|mab|markdown|md|mdown|mediawiki|mkd|mw|nokogiri|radius|rb|rdoc|rhtml|ru|styl|sass|scss|str|textile|txt|wiki|yajl|yml)$/
